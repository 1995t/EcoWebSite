...
<body>
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-6">
					<div class=""><img class="image-fluid mt-2 ml-5" src="../images/nature.png" ></div>
					
			</div>	
	        <div class="col-sm-6">
					
					<div class="user-spacing"><a href="index.php"><h2 class="text-success">User</h2></a></div>
			  ...
			  <div class="col-sm-4">
				    <div class="text-center">
					  <form class="form-signin" action="" method="post">
						  <h1 class="h3 mb-3 font-weight-normal text-success">Admin Sign In</h1>
						  ...
						  <input class="btn btn-lg btn-primary btn-block mb-3" type="submit" value="Sign in" name="submit" onClick="return validate()">
                          <p class="mt-3"><a href="create_admin.php">Create Admin</a></p>
  ...
  if(isset($_POST['submit']))
   {
	  ...
	  else
	  {
		  ...
		  {
			echo "<b>password did not match.</b>";
